...
// const OptimizeCSSAssetsPlugin = require ("optimize-css-assets-webpack-plugin"); // minimize css for prod
// const UglifyJsPlugin          = require ("uglifyjs-webpack-plugin"); // needed for the minimize js
// helpers
...
const PATHS = {
  ...
  // googleAnalytics : path.resolve(__dirname, `${sourceFolder}/client/js/googleAnalytics.js`)
};
...
const videos = {
  test: /\.mp4$/,
  use: 'url-loader?name=videos/[name].[ext]',
};
...
module.exports = {
  ...
  module: {
    rules: [javascript, styles, images, html, fonts],
  },
  resolve: {
